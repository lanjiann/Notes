...
** TODO 4 Handling errors without exceptions - 48 =ing...=
...
*** TODO 4.3 The ~Option~ data type - 52
    - The solution is to represent explicitly in the return type that a function
      ...
      strategy.
**** 4.3.1 Usage patterns for ~Option~ - 53
...
**** 4.3.2 ~Option~ composition, lifting, and wrapping exception-oriented APIs - 56
     - /lift/:
       #+BEGIN_SRC scala
...
*** TODO 4.4 The ~Either~ data type - 60
