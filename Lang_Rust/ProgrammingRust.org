...
- [[17. Strings and Text - 391][17. Strings and Text - 391]]
  ...
  - [[Formatting Values - 413 - =Reading=][Formatting Values - 413 - =Reading=]]
...
** DONE Using Traits - 237
   ...
   - In Rust, there is one UNUSUAL RULE about /trait methods/:
   ...
   - Rust's /traits/' /methods/ are like /virtual methods/ in C++ and C#, while
     there is NO runtime overhead in Rust.
...
*** DONE Trait Objects - 238
    ...
    - Rust does *NOT* permit variables of type ~Write~:
      ...
      + You may be surprising if you're coming from C# or Java, but the reason is
        simple. In both of them, you actually save a /reference/, which has a
        known size -- this is NOT the case in Rust, Rust doesn't save a reference
        by default.
      ...
      + What makes a /trait object/ different is that
        ...
        * Rust does _NOT support_ /downcasting/ from the /trait object/ ~&mut Write~
          back to a concrete type like ~Vec<u8>~.

*** DONE Trait Object Layout - 239
    CLOSED: [2018-06-20 Wed 02:30]
...
*** TODO Default Methods - 246
    ...
    method(s)/. The /core method(s)/ are the most specific for each type, and they
    should be implemented by the user who define this type. The /common method(s)/
    are the /methods/ that use the /core method(s)/ to do something, and they are
    NOT very specific 



    When you ~impl~ a /trait/, you only need to implement its /methods/ that are
    VERY SPECIFIC for your type (structs, enums, ...), most of other /methods/
    have default implementations -- they are /default methods/.
...
** TODO Formatting Values - 413 - =Reading=
