...
- [[3. Creating Types in C# - 73][3. Creating Types in C# - 73]]
...
- [[4. Advanced C# - 127][4. Advanced C# - 127]]
  ...
  - [[Lambda Expressions - 143][Lambda Expressions - 143]]
...
- [[5. Framework Overview - 199][5. Framework Overview - 199]]
  - [[The CLR and Core Framework - 202][The CLR and Core Framework - 202]]
    - [[System Types - 202][System Types - 202]]
    - [[Text Processing - 202][Text Processing - 202]]
    - [[Collections - 202][Collections - 202]]
    - [[Queries - 202][Queries - 202]]
    - [[XML - 203][XML - 203]]
    - [[Diagnostics and Code Contracts - 203][Diagnostics and Code Contracts - 203]]
    - [[Concurrency and Asynchrony - 203][Concurrency and Asynchrony - 203]]
    - [[Streams and I/O - 204][Streams and I/O - 204]]
    - [[Networking - 204][Networking - 204]]
    - [[Serialization - 204][Serialization - 204]]
    - [[Assemblies, Reflection, and Attributes - 204][Assemblies, Reflection, and Attributes - 204]]
    - [[Dynamic Programming - 205][Dynamic Programming - 205]]
    - [[Security - 205][Security - 205]]
    - [[Advanced Threading - 205][Advanced Threading - 205]]
    - [[Parallel Programming - 205][Parallel Programming - 205]]
    - [[Application Domains - 206][Application Domains - 206]]
    - [[Native and COM Interoperability - 206][Native and COM Interoperability - 206]]
  - [[Applied Technologies - 206][Applied Technologies - 206]]
    - [[User Interface Technologies - 206][User Interface Technologies - 206]]
      - [[ASP.NET - 206][ASP.NET - 206]]
      - [[Windows Presentation Foundation (WPF) - 207][Windows Presentation Foundation (WPF) - 207]]
      - [[Windows Forms - 208][Windows Forms - 208]]
      - [[Windows RT and Xamarin - 208][Windows RT and Xamarin - 208]]
      - [[Silverlight - 209][Silverlight - 209]]
    - [[Backend Technologies - 209][Backend Technologies - 209]]
      - [[ADO.NET - 209][ADO.NET - 209]]
      - [[Windows Workflow - 210][Windows Workflow - 210]]
      - [[COM+ and MSMQ - 210][COM+ and MSMQ - 210]]
    - [[Distributed System Technologies - 210][Distributed System Technologies - 210]]
      - [[Windows Communication Foundation (WCF) - 210][Windows Communication Foundation (WCF) - 210]]
      - [[Web API - 211][Web API - 211]]
      - [[Remoting and .ASMX Web Services - 211][Remoting and .ASMX Web Services - 211]]
...
- [[25. Interoperability - 1003][25. Interoperability - 1003]]
  - [[Calling into Native DLLs - 1003][Calling into Native DLLs - 1003]]
  - [[Type Marshaling - 1004][Type Marshaling - 1004]]
    - [[Marshaling Common Types - 1004][Marshaling Common Types - 1004]]
    - [[Marshaling Classes and Structs - 1005][Marshaling Classes and Structs - 1005]]
    - [[In and Out Marshaling - 1006][In and Out Marshaling - 1006]]
  - [[Callbacks from Unmanaged Code - 1007][Callbacks from Unmanaged Code - 1007]]
  - [[Simulating a C Union - 1007][Simulating a C Union - 1007]]
  - [[Shared Memory - 1008][Shared Memory - 1008]]
  - [[Mapping a Struct to Unmanaged Memory - 1011][Mapping a Struct to Unmanaged Memory - 1011]]
    - [[fixed and fixed {...} - 1014][fixed and fixed {...} - 1014]]
  - [[COM Interoperability - 1015][COM Interoperability - 1015]]
    - [[The Purpose of COM - 1015][The Purpose of COM - 1015]]
    - [[The Basics of the COM Type System - 1016][The Basics of the COM Type System - 1016]]
      - [[~IUnknown~ and ~IDispatch~][~IUnknown~ and ~IDispatch~]]
  - [[Calling a COM Component from C# - 1017][Calling a COM Component from C# - 1017]]
    - [[Optional Parameters and Named Arguments - 1018][Optional Parameters and Named Arguments - 1018]]
    - [[Implicit ref Parameters - 1019][Implicit ref Parameters - 1019]]
    - [[Indexers - 1019][Indexers - 1019]]
    - [[Dynamic Binding - 1020][Dynamic Binding - 1020]]
  - [[Embedding Interop Types - 1020][Embedding Interop Types - 1020]]
    - [[Type Equivalence - 1021][Type Equivalence - 1021]]
  - [[Primary Interop Assemblies - 1021][Primary Interop Assemblies - 1021]]
  - [[Exposing C# Objects to COM - 1022][Exposing C# Objects to COM - 1022]]
- [[26. Regular Expressions - 1023][26. Regular Expressions - 1023]]
  - [[Regular Expression Basics - 1024][Regular Expression Basics - 1024]]
    - [[Compiled Regular Expressions - 1025][Compiled Regular Expressions - 1025]]
    - [[RegexOptions - 1025][RegexOptions - 1025]]
    - [[Character Escapes - 1026][Character Escapes - 1026]]
    - [[Character Sets - 1027][Character Sets - 1027]]
  - [[Quantifiers - 1028][Quantifiers - 1028]]
    - [[Greedy Versus Lazy Quantifiers - 1029][Greedy Versus Lazy Quantifiers - 1029]]
  - [[Zero-Width Assertions - 1029][Zero-Width Assertions - 1029]]
    - [[Lookahead and Lookbehind - 1029][Lookahead and Lookbehind - 1029]]
    - [[Anchors - 1030][Anchors - 1030]]
    - [[Word Boundaries - 1031][Word Boundaries - 1031]]
  - [[Groups - 1032][Groups - 1032]]
    - [[Named Groups - 1033][Named Groups - 1033]]
  - [[Replacing and Splitting Text - 1033][Replacing and Splitting Text - 1033]]
    - [[MatchEvaluator Delegate - 1034][MatchEvaluator Delegate - 1034]]
    - [[Splitting Text - 1034][Splitting Text - 1034]]
  - [[Cookbook Regular Expressions - 1035][Cookbook Regular Expressions - 1035]]
    - [[Recipes - 1035][Recipes - 1035]]
  ...
  - [[Regular Expressions Language Reference - 1038][Regular Expressions Language Reference - 1038]]
- [[27. The Roslyn Compiler - 1043][27. The Roslyn Compiler - 1043]]
  - [[Roslyn Architecture - 1044][Roslyn Architecture - 1044]]
    - [[Workspaces - 1044][Workspaces - 1044]]
  - [[Syntax Trees - 1045][Syntax Trees - 1045]]
    - [[SyntaxTree Structure - 1045][SyntaxTree Structure - 1045]]
      - [[Common properties and methods - 1047][Common properties and methods - 1047]]
    - [[Obtaining a Syntax Tree - 1048][Obtaining a Syntax Tree - 1048]]
    - [[Traversing and Searching a Tree - 1049][Traversing and Searching a Tree - 1049]]
      - [[Traversing children - 1050][Traversing children - 1050]]
      - [[Traversing parents - 1052][Traversing parents - 1052]]
      - [[Finding a child by its offset - 1052][Finding a child by its offset - 1052]]
      - [[CSharpSyntaxWalker - 1053][CSharpSyntaxWalker - 1053]]
    - [[Trivia - 1053][Trivia - 1053]]
      - [[Preprocessor directives - 1054][Preprocessor directives - 1054]]
      - [[Structured trivia - 1055][Structured trivia - 1055]]
    - [[Transforming a Syntax Tree - 1056][Transforming a Syntax Tree - 1056]]
      - [[Handling changes to the source code - 1057][Handling changes to the source code - 1057]]
      - [[Creating new nodes, tokens, and trivia with SyntaxFactory - 1057][Creating new nodes, tokens, and trivia with SyntaxFactory - 1057]]
      - [[CSharpSyntaxRewriter - 1059][CSharpSyntaxRewriter - 1059]]
  - [[Compilations and Semantic Models - 1060][Compilations and Semantic Models - 1060]]
    - [[Creating a Compilation - 1060][Creating a Compilation - 1060]]
      - [[Diagnostics - 1062][Diagnostics - 1062]]
    - [[Emitting an Assembly - 1062][Emitting an Assembly - 1062]]
    - [[Querying the Semantic Model - 1062][Querying the Semantic Model - 1062]]
      - [[Symbols - 1063][Symbols - 1063]]
      - [[SymbolInfo -1064][SymbolInfo -1064]]
      - [[Symbol accessibility - 1065][Symbol accessibility - 1065]]
      - [[Declared symbols - 1065][Declared symbols - 1065]]
      - [[TypeInfo - 1066][TypeInfo - 1066]]
      - [[Looking up symbols - 1066][Looking up symbols - 1066]]
    - [[Example: Renaming a Symbol - 1067][Example: Renaming a Symbol - 1067]]
