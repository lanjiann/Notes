...
- [[3 Defining and calling functions - 44][3 Defining and calling functions - 44]]
  ...
  - [[3.3 Adding methods to other people's classes: extension functions and properties - 51][3.3 Adding methods to other people's classes: extension functions and properties - 51]]
    ...
    - [[3.3.4 No overriding for extension functions - 55][3.3.4 No overriding for extension functions - 55]]
    - [[3.3.5 Extension properties - 56][3.3.5 Extension properties - 56]]
...
- [[4 Classes, objects, and interfaces - 67 -- =Reading=][4 Classes, objects, and interfaces - 67 -- =Reading=]]
  - [[4.1 Defining class hierarchies - 68][4.1 Defining class hierarchies - 68]]
    - [[4.1.1 Interfaces in Kotlin - 68][4.1.1 Interfaces in Kotlin - 68]]
    - [[4.1.2 ~open~, ~final~, and ~abstract~ modifiers: ~final~ by default - 70][4.1.2 ~open~, ~final~, and ~abstract~ modifiers: ~final~ by default - 70]]
    - [[4.1.3 Visibility modifiers: public by default - 73][4.1.3 Visibility modifiers: public by default - 73]]
    - [[4.1.4 Inner and nested classes: nested by default - 75][4.1.4 Inner and nested classes: nested by default - 75]]
    - [[4.1.5 Sealed classes: defining restricted class hierarchies - 77][4.1.5 Sealed classes: defining restricted class hierarchies - 77]]
  - [[4.2 Declaring a class with nontrivial constructors or properties - 78][4.2 Declaring a class with nontrivial constructors or properties - 78]]
    - [[4.2.1 Initializing classes: primary constructor and initializer blocks - 79][4.2.1 Initializing classes: primary constructor and initializer blocks - 79]]
    - [[4.2.2 Secondary constructors: initializing the superclass in different ways - 81][4.2.2 Secondary constructors: initializing the superclass in different ways - 81]]
    - [[4.2.3 Implementing properties declared in interfaces - 83][4.2.3 Implementing properties declared in interfaces - 83]]
    - [[4.2.4 Accessing a backing field from a getter or setter - 85][4.2.4 Accessing a backing field from a getter or setter - 85]]
    - [[4.2.5 Changing accessor visibility - 86][4.2.5 Changing accessor visibility - 86]]
  - [[4.3 Compiler-generated methods: data classes and class delegation - 87][4.3 Compiler-generated methods: data classes and class delegation - 87]]
    - [[4.3.1 Universal object methods - 87][4.3.1 Universal object methods - 87]]
      - [[String Representation: ~toString()~][String Representation: ~toString()~]]
      - [[Object Equality: ~equals()~][Object Equality: ~equals()~]]
      - [[Hash Containers: ~hashCode()~][Hash Containers: ~hashCode()~]]
    - [[4.3.2 Data classes: autogenerated implementations of universal methods - 89][4.3.2 Data classes: autogenerated implementations of universal methods - 89]]
      - [[Data Classes and Immutability: The ~copy~ method][Data Classes and Immutability: The ~copy~ method]]
    - [[4.3.3 Class delegation: using the ~by~ keyword - 91][4.3.3 Class delegation: using the ~by~ keyword - 91]]
  - [[4.4 The ~object~ keyword: declaring a class and creating an instance, combined - 93][4.4 The ~object~ keyword: declaring a class and creating an instance, combined - 93]]
    - [[4.4.1 Object declarations: singletons made easy - 93][4.4.1 Object declarations: singletons made easy - 93]]
    - [[4.4.2 Companion objects: a place for factory methods and static members - 96][4.4.2 Companion objects: a place for factory methods and static members - 96]]
    - [[4.4.3 Companion objects as regular objects - 98][4.4.3 Companion objects as regular objects - 98]]
    - [[4.4.4 Object expressions: anonymous inner classes rephrased - 100][4.4.4 Object expressions: anonymous inner classes rephrased - 100]]
  - [[4.5 Summary - 101][4.5 Summary - 101]]
- [[5 Programming with lambdas - 103 -- =Reading=][5 Programming with lambdas - 103 -- =Reading=]]
  - [[5.1 Lambda expressions and member references - 104][5.1 Lambda expressions and member references - 104]]
    - [[5.1.1 Introduction to lambdas: blocks of code as function parameters - 104][5.1.1 Introduction to lambdas: blocks of code as function parameters - 104]]
    - [[5.1.2 Lambdas and collections - 105][5.1.2 Lambdas and collections - 105]]
    - [[5.1.3 Syntax for lambda expressions - 106][5.1.3 Syntax for lambda expressions - 106]]
    - [[5.1.4 Accessing variables in scope - 109][5.1.4 Accessing variables in scope - 109]]
    - [[5.1.5 Member references - 111][5.1.5 Member references - 111]]
  - [[5.2 Functional APIs for collections - 113][5.2 Functional APIs for collections - 113]]
    - [[5.2.1 Essentials: ~filter~ and ~map~ - 113][5.2.1 Essentials: ~filter~ and ~map~ - 113]]
    - [[5.2.2 ~all~, ~any~, ~count~, and ~find~: applying a predicate to a collection - 115][5.2.2 ~all~, ~any~, ~count~, and ~find~: applying a predicate to a collection - 115]]
    - [[5.2.3 ~groupBy~: converting a list to a map of groups - 117][5.2.3 ~groupBy~: converting a list to a map of groups - 117]]
    - [[5.2.4 ~flatMap~ and ~flatten~: processing elements in nested collections - 117][5.2.4 ~flatMap~ and ~flatten~: processing elements in nested collections - 117]]
  - [[5.3 Lazy collection operations: sequences - 118][5.3 Lazy collection operations: sequences - 118]]
    - [[5.3.1 Executing sequence operations: intermediate and terminal operations - 120][5.3.1 Executing sequence operations: intermediate and terminal operations - 120]]
    - [[5.3.2 Creating sequences - 122][5.3.2 Creating sequences - 122]]
  - [[5.4 Using Java functional interfaces - 123][5.4 Using Java functional interfaces - 123]]
    - [[5.4.1 Passing a lambda as a parameter to a Java method - 124][5.4.1 Passing a lambda as a parameter to a Java method - 124]]
    - [[5.4.2 SAM constructors: explicit conversion of lambdas to functional interfaces - 126][5.4.2 SAM constructors: explicit conversion of lambdas to functional interfaces - 126]]
  - [[5.5 Lambdas with receivers: ~with~ and ~apply~ - 128][5.5 Lambdas with receivers: ~with~ and ~apply~ - 128]]
    - [[5.5.1 The ~with~ function - 128][5.5.1 The ~with~ function - 128]]
    - [[5.5.2 The ~apply~ function - 130][5.5.2 The ~apply~ function - 130]]
  - [[5.6 Summary - 131][5.6 Summary - 131]]
- [[6 The Kotlin type system - 133 -- =Reading=][6 The Kotlin type system - 133 -- =Reading=]]
  - [[6.1 Nullability - 133][6.1 Nullability - 133]]
    - [[6.1.1 Nullable types - 134][6.1.1 Nullable types - 134]]
    - [[6.1.2 The meaning of types - 136][6.1.2 The meaning of types - 136]]
    - [[6.1.3 Safe call operator: ~?.~ - 137][6.1.3 Safe call operator: ~?.~ - 137]]
    - [[6.1.4 Elvis operator: ~?:~ - 139][6.1.4 Elvis operator: ~?:~ - 139]]
    - [[6.1.5 Safe casts: ~as?~ - 140][6.1.5 Safe casts: ~as?~ - 140]]
    - [[6.1.6 Not-null assertions: ~!!~ - 141 =???= =TODO= =RE-READ=][6.1.6 Not-null assertions: ~!!~ - 141 =???= =TODO= =RE-READ=]]
    - [[6.1.7 The ~let~ function - 143][6.1.7 The ~let~ function - 143]]
    - [[6.1.8 Late-initialized properties - 145][6.1.8 Late-initialized properties - 145]]
    - [[6.1.9 Extensions for nullable types - 146][6.1.9 Extensions for nullable types - 146]]
    - [[6.1.10 Nullability of type parameters - 148][6.1.10 Nullability of type parameters - 148]]
    - [[6.1.11 Nullability and Java - 149][6.1.11 Nullability and Java - 149]]
  - [[6.2 Primitive and other basic types - 153][6.2 Primitive and other basic types - 153]]
    - [[6.2.1 Primitive types: ~Int~, ~Boolean~, and more - 153][6.2.1 Primitive types: ~Int~, ~Boolean~, and more - 153]]
    - [[6.2.2 Nullable primitive types: ~Int?~, ~Boolean?~, and more - 154][6.2.2 Nullable primitive types: ~Int?~, ~Boolean?~, and more - 154]]
    - [[6.2.3 Number conversions - 155][6.2.3 Number conversions - 155]]
    - [[6.2.4 ~Any~ and ~Any?~: the root types - 157][6.2.4 ~Any~ and ~Any?~: the root types - 157]]
    - [[6.2.5 The ~Unit~ type: Kotlin's ~void~ - 157][6.2.5 The ~Unit~ type: Kotlin's ~void~ - 157]]
    - [[6.2.6 The ~Nothing~ type: "This function never returns" - 158][6.2.6 The ~Nothing~ type: "This function never returns" - 158]]
  - [[6.3 Collections and arrays - 159][6.3 Collections and arrays - 159]]
    - [[6.3.1 Nullability and collections - 159][6.3.1 Nullability and collections - 159]]
    - [[6.3.2 Read-only and mutable collections - 161][6.3.2 Read-only and mutable collections - 161]]
    - [[6.3.3 Kotlin collections and Java - 163][6.3.3 Kotlin collections and Java - 163]]
    - [[6.3.4 Collections as platform types - 165][6.3.4 Collections as platform types - 165]]
    - [[6.3.5 Arrays of objects and primitive types - 167][6.3.5 Arrays of objects and primitive types - 167]]
...
- [[appendix A Building Kotlin projects - 313][appendix A Building Kotlin projects - 313]]
  - [[A.1 Building Kotlin code with Gradle - 313][A.1 Building Kotlin code with Gradle - 313]]
    - [[A.1.1 Building Kotlin Android applications with Gradle - 314][A.1.1 Building Kotlin Android applications with Gradle - 314]]
    - [[A.1.2 Building projects that use annotation processing - 314][A.1.2 Building projects that use annotation processing - 314]]
  - [[A.2 Building Kotlin projects with Maven - 315][A.2 Building Kotlin projects with Maven - 315]]
  - [[A.3 Building Kotlin code with Ant - 315][A.3 Building Kotlin code with Ant - 315]]
- [[appendix B Documenting Kotlin code - 317][appendix B Documenting Kotlin code - 317]]
  - [[B.1 Writing Kotlin documentation comments - 317][B.1 Writing Kotlin documentation comments - 317]]
  - [[B.2 Generating API documentation - 319][B.2 Generating API documentation - 319]]
- [[appendix C The Kotlin ecosystem - 320][appendix C The Kotlin ecosystem - 320]]
  - [[C.1 Testing - 320][C.1 Testing - 320]]
  - [[C.2 Dependency injection - 321][C.2 Dependency injection - 321]]
  - [[C.3 JSON serialization - 321][C.3 JSON serialization - 321]]
  - [[C.4 HTTP clients - 321][C.4 HTTP clients - 321]]
  - [[C.5 Web applications - 321][C.5 Web applications - 321]]
  - [[C.6 Database access - 322][C.6 Database access - 322]]
  - [[C.7 Utilities and data structures - 322][C.7 Utilities and data structures - 322]]
  - [[C.8 Desktop programming - 322][C.8 Desktop programming - 322]]
- [[index - 323][index - 323]]
