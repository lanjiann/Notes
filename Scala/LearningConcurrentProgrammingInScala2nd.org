...
- [[Preface - 1][Preface - 1]]
- [[Chapter 1: Introduction - 13][Chapter 1: Introduction - 13]]
  - [[Concurrent programming - 14][Concurrent programming - 14]]
    - [[A brief overview of traditional concurrency - 15][A brief overview of traditional concurrency - 15]]
    - [[Modern concurrency paradigms - 15][Modern concurrency paradigms - 15]]
  - [[The advantages of Scala - 17][The advantages of Scala - 17]]
  - [[Preliminaries - 18][Preliminaries - 18]]
    - [[Execution of a Scala program - 18][Execution of a Scala program - 18]]
    - [[A Scala primer - 20][A Scala primer - 20]]
  - [[Overview of new features in Scala 2.12 - 25][Overview of new features in Scala 2.12 - 25]]
  - [[Summary - 26][Summary - 26]]
  - [[Exercises - 26][Exercises - 26]]
- [[Chapter 2: Concurrency on the JVM and the Java Memory Model - 29][Chapter 2: Concurrency on the JVM and the Java Memory Model - 29]]
  - [[Processes and threads - 30][Processes and threads - 30]]
    - [[Creating and starting threads - 33][Creating and starting threads - 33]]
    - [[Atomic execution - 38][Atomic execution - 38]]
    - [[Reordering - 42][Reordering - 42]]
  - [[Monitors and synchronization - 45][Monitors and synchronization - 45]]
    - [[Deadlocks - 47][Deadlocks - 47]]
    - [[Guarded blocks - 50][Guarded blocks - 50]]
    - [[Interrupting threads and the graceful shutdown - 55][Interrupting threads and the graceful shutdown - 55]]
  - [[Volatile variables - 56][Volatile variables - 56]]
  - [[The Java Memory Model - 58][The Java Memory Model - 58]]
    - [[Immutable objects and final fields - 60][Immutable objects and final fields - 60]]
  - [[Summary - 62][Summary - 62]]
  - [[Exercises - 63][Exercises - 63]]
- [[Chapter 3: Traditional Building Blocks of Concurrency - 67][Chapter 3: Traditional Building Blocks of Concurrency - 67]]
  - [[The Executor and ExecutionContext objects - 68][The Executor and ExecutionContext objects - 68]]
  - [[Atomic primitives - 72][Atomic primitives - 72]]
    - [[Atomic variables - 73][Atomic variables - 73]]
    - [[Lock-free programming - 76][Lock-free programming - 76]]
    - [[Implementing locks explicitly - 78][Implementing locks explicitly - 78]]
    - [[The ABA problem - 80][The ABA problem - 80]]
  - [[Lazy values - 83][Lazy values - 83]]
  - [[Concurrent collections - 88][Concurrent collections - 88]]
    - [[Concurrent queues - 89][Concurrent queues - 89]]
    - [[Concurrent sets and maps - 93][Concurrent sets and maps - 93]]
    - [[Concurrent traversals - 98][Concurrent traversals - 98]]
  - [[Custom concurrent data structures - 101][Custom concurrent data structures - 101]]
    - [[Implementing a lock-free concurrent pool - 102][Implementing a lock-free concurrent pool - 102]]
    - [[Creating and handling processes - 106][Creating and handling processes - 106]]
  - [[Summary - 108][Summary - 108]]
  - [[Exercises - 109][Exercises - 109]]
- [[Chapter 4: Asynchronous Programming with Futures and Promises - 112][Chapter 4: Asynchronous Programming with Futures and Promises - 112]]
  - [[Futures - 113][Futures - 113]]
    - [[Starting future computations - 115][Starting future computations - 115]]
    - [[Future callbacks - 117][Future callbacks - 117]]
    - [[Futures and exceptions - 120][Futures and exceptions - 120]]
    - [[Using the Try type - 121][Using the Try type - 121]]
    - [[Fatal exceptions - 123][Fatal exceptions - 123]]
    - [[Functional composition on futures - 124][Functional composition on futures - 124]]
  - [[Promises - 132][Promises - 132]]
    - [[Converting callback-based APIs - 134][Converting callback-based APIs - 134]]
    - [[Extending the future API - 137][Extending the future API - 137]]
    - [[Cancellation of asynchronous computations - 138][Cancellation of asynchronous computations - 138]]
  - [[Futures and blocking - 141][Futures and blocking - 141]]
    - [[Awaiting futures - 141][Awaiting futures - 141]]
    - [[Blocking in asynchronous computations - 142][Blocking in asynchronous computations - 142]]
  - [[The Scala Async library - 143][The Scala Async library - 143]]
  - [[Alternative future frameworks - 146][Alternative future frameworks - 146]]
  - [[Summary - 148][Summary - 148]]
  - [[Exercises - 148][Exercises - 148]]
- [[Chapter 5: Data-Parallel Collections - 152][Chapter 5: Data-Parallel Collections - 152]]
  - [[Scala collections in a nutshell - 153][Scala collections in a nutshell - 153]]
  - [[Using parallel collections - 154][Using parallel collections - 154]]
    - [[Parallel collection class hierarchy - 158][Parallel collection class hierarchy - 158]]
    - [[Configuring the parallelism level - 160][Configuring the parallelism level - 160]]
    - [[Measuring the performance on the JVM - 161][Measuring the performance on the JVM - 161]]
  - [[Caveats with parallel collections - 164][Caveats with parallel collections - 164]]
    - [[Non-parallelizable collections - 164][Non-parallelizable collections - 164]]
    - [[Non-parallelizable operations - 165][Non-parallelizable operations - 165]]
    - [[Side effects in parallel operations - 168][Side effects in parallel operations - 168]]
    - [[Nondeterministic parallel operations - 169][Nondeterministic parallel operations - 169]]
    - [[Commutative and associative operators - 170][Commutative and associative operators - 170]]
  - [[Using parallel and concurrent collections together - 173][Using parallel and concurrent collections together - 173]]
    - [[Weakly consistent iterators - 174][Weakly consistent iterators - 174]]
  - [[Implementing custom parallel collections - 175][Implementing custom parallel collections - 175]]
    - [[Splitters - 176][Splitters - 176]]
    - [[Combiners - 179][Combiners - 179]]
  - [[Summary - 182][Summary - 182]]
  - [[Exercises - 184][Exercises - 184]]
- [[Chapter 6: Concurrent Programming with Reactive Extensions - 186][Chapter 6: Concurrent Programming with Reactive Extensions - 186]]
  - [[Creating Observable objects - 188][Creating Observable objects - 188]]
    - [[Observables and exceptions - 190][Observables and exceptions - 190]]
    - [[The Observable contract - 192][The Observable contract - 192]]
    - [[Implementing custom Observable objects - 194][Implementing custom Observable objects - 194]]
    - [[Creating Observables from futures - 195][Creating Observables from futures - 195]]
    - [[Subscriptions - 196][Subscriptions - 196]]
  - [[Composing Observable objects - 199][Composing Observable objects - 199]]
    - [[Nested Observables - 201][Nested Observables - 201]]
    - [[Failure handling in Observables - 206][Failure handling in Observables - 206]]
  - [[Rx schedulers - 209][Rx schedulers - 209]]
    - [[Using custom schedulers for UI applications - 211][Using custom schedulers for UI applications - 211]]
  - [[Subjects and top-down reactive programming - 218][Subjects and top-down reactive programming - 218]]
  - [[Summary - 223][Summary - 223]]
  - [[Exercises - 223][Exercises - 223]]
- [[Chapter 7: Software Transactional Memory - 227][Chapter 7: Software Transactional Memory - 227]]
  - [[The trouble with atomic variables - 228][The trouble with atomic variables - 228]]
  - [[Using Software Transactional Memory - 232][Using Software Transactional Memory - 232]]
    - [[Transactional references - 235][Transactional references - 235]]
    - [[Using the atomic statement - 236][Using the atomic statement - 236]]
  - [[Composing transactions - 238][Composing transactions - 238]]
    - [[The interaction between transactions and side effects - 238][The interaction between transactions and side effects - 238]]
    - [[Single-operation transactions - 243][Single-operation transactions - 243]]
    - [[Nesting transactions - 244][Nesting transactions - 244]]
    - [[Transactions and exceptions - 247][Transactions and exceptions - 247]]
  - [[Retrying transactions - 252][Retrying transactions - 252]]
    - [[Retrying with timeouts - 256][Retrying with timeouts - 256]]
  - [[Transactional collections - 258][Transactional collections - 258]]
    - [[Transaction-local variables - 258][Transaction-local variables - 258]]
    - [[Transactional arrays - 259][Transactional arrays - 259]]
    - [[Transactional maps - 261][Transactional maps - 261]]
  - [[Summary - 263][Summary - 263]]
  - [[Exercises - 264][Exercises - 264]]
- [[Chapter 8: Actors - 267][Chapter 8: Actors - 267]]
  - [[Working with actors - 268][Working with actors - 268]]
    - [[Creating actor systems and actors - 271][Creating actor systems and actors - 271]]
    - [[Managing unhandled messages - 274][Managing unhandled messages - 274]]
    - [[Actor behavior and state - 276][Actor behavior and state - 276]]
    - [[Akka actor hierarchy - 282][Akka actor hierarchy - 282]]
    - [[Identifying actors - 285][Identifying actors - 285]]
    - [[The actor lifecycle - 288][The actor lifecycle - 288]]
  - [[Communication between actors - 292][Communication between actors - 292]]
    - [[The ask pattern - 294][The ask pattern - 294]]
    - [[The forward pattern - 297][The forward pattern - 297]]
    - [[Stopping actors - 298][Stopping actors - 298]]
  - [[Actor supervision - 300][Actor supervision - 300]]
  - [[Remote actors - 306][Remote actors - 306]]
  - [[Summary - 310][Summary - 310]]
  - [[Exercises - 310][Exercises - 310]]
- [[Chapter 9: Concurrency in Practice - 313][Chapter 9: Concurrency in Practice - 313]]
  - [[Choosing the right tools for the job - 314][Choosing the right tools for the job - 314]]
  - [[Putting it all together – a remote file browser - 319][Putting it all together – a remote file browser - 319]]
    - [[Modeling the filesystem - 320][Modeling the filesystem - 320]]
    - [[The server interface - 324][The server interface - 324]]
    - [[Client navigation API - 326][Client navigation API - 326]]
    - [[The client user interface - 330][The client user interface - 330]]
    - [[Implementing the client logic - 334][Implementing the client logic - 334]]
    - [[Improving the remote file browser - 339][Improving the remote file browser - 339]]
  - [[Debugging concurrent programs - 340][Debugging concurrent programs - 340]]
    - [[Deadlocks and lack of progress - 341][Deadlocks and lack of progress - 341]]
    - [[Debugging incorrect program outputs - 346][Debugging incorrect program outputs - 346]]
    - [[Performance debugging - 351][Performance debugging - 351]]
  - [[Summary - 358][Summary - 358]]
  - [[Exercises - 359][Exercises - 359]]
- [[Chapter 10: Reactors - 361][Chapter 10: Reactors - 361]]
  - [[The need for reactors - 362][The need for reactors - 362]]
  - [[Getting started with Reactors - 364][Getting started with Reactors - 364]]
  - [[The “Hello World” program - 364][The “Hello World” program - 364]]
  - [[Event streams - 366][Event streams - 366]]
    - [[Lifecycle of an event stream - 367][Lifecycle of an event stream - 367]]
    - [[Functional composition of event streams - 369][Functional composition of event streams - 369]]
  - [[Reactors - 371][Reactors - 371]]
    - [[Defining and configuring reactors - 373][Defining and configuring reactors - 373]]
    - [[Using channels - 374][Using channels - 374]]
  - [[Schedulers - 377][Schedulers - 377]]
  - [[Reactor lifecycle - 378][Reactor lifecycle - 378]]
  - [[Reactor system services - 381][Reactor system services - 381]]
    - [[The logging service - 381][The logging service - 381]]
    - [[The clock service - 382][The clock service - 382]]
    - [[The channels service - 383][The channels service - 383]]
    - [[Custom services - 384][Custom services - 384]]
  - [[Protocols - 387][Protocols - 387]]
    - [[Custom server-client protocol - 387][Custom server-client protocol - 387]]
    - [[Standard server-client protocol - 390][Standard server-client protocol - 390]]
      - [[Using an existing connector - 391][Using an existing connector - 391]]
      - [[Creating a new connector - 391][Creating a new connector - 391]]
      - [[Creating a protocol-specific reactor prototype - 392][Creating a protocol-specific reactor prototype - 392]]
      - [[Spawning a protocol-specific reactor directly - 393][Spawning a protocol-specific reactor directly - 393]]
    - [[Router protocol - 393][Router protocol - 393]]
    - [[Two-way protocol - 395][Two-way protocol - 395]]
  - [[Summary - 399][Summary - 399]]
  - [[Exercises - 399][Exercises - 399]]
- [[Index - 402][Index - 402]]
