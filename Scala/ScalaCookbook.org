...
- [[12. Files and Processes - 375][12. Files and Processes - 375]]
  - [[12.1. How to Open and Read a Text File - 375][12.1. How to Open and Read a Text File - 375]]
    ...
    - [[Discussion][Discussion]]
      - [[Leaving files open][Leaving files open]]
      - [[Automatically closing the resource][Automatically closing the resource]]
      - [[Handling exceptions][Handling exceptions]]
      - [[Multiple fromFile methods][Multiple fromFile methods]]
...
* 12. Files and Processes - 375
  ...
  - In other cases:
    such as when reading a YAML file or working with directories, you simply
    _fall back to use existing Java libraries_.
