...
- [[Indentation][Indentation]]
  ...
  - [[Methods with Numerous Arguments][Methods with Numerous Arguments]]
- [[Naming Conventions][Naming Conventions]]
  - [[Classes/Traits][Classes/Traits]]
  - [[Objects][Objects]]
  - [[Packages][Packages]]
    - [[root][root]]
  - [[Methods][Methods]]
    ...
    - [[Symbolic Method Names =RE-READ=][Symbolic Method Names =RE-READ=]]
  - [[Constants, Values, Variable and Methods][Constants, Values, Variable and Methods]]
  - [[Type Parameters (generics)][Type Parameters (generics)]]
    - [[Higher-Kinds and Parameterized Type parameters =RE-READ=][Higher-Kinds and Parameterized Type parameters =RE-READ=]]
...
- [[Nested Blocks][Nested Blocks]]
    ...
    - [[Parentheses][Parentheses]]
- [[Files][Files]]
  - [[Multi-Unit Files][Multi-Unit Files]]
- [[Control Structures][Control Structures]]
  - [[Curly-Braces][Curly-Braces]]
  - [[~for~ =RE-READ=][~for~ =RE-READ=]]
    - [[~for~ Comprehensions][~for~ Comprehensions]]
    - [[~for~ Loop][~for~ Loop]]
  - [[Trivial Conditionals][Trivial Conditionals]]
...
- [[Declarations][Declarations]]
  - [[Classes][Classes]]
    ...
    - [[Methods][Methods]]
      ...
      - [[Modifiers =RE-READ=][Modifiers =RE-READ=]]
      - [[Body][Body]]
      - [[Multiple Parameter Lists (=From Jian= currying)][Multiple Parameter Lists (=From Jian= currying)]]
      - [[Higher-Order Functions][Higher-Order Functions]]
    - [[Fields][Fields]]
  - [[Function Values][Function Values]]
    - [[Spacing][Spacing]]
    - [[Multi-Expression Functions][Multi-Expression Functions]]
- [[Scaladoc][Scaladoc]]
...
** TODO General Style
** TODO Packages
** TODO Classes, Objects, and Traits
*** TODO Classes
*** TODO Objects
*** TODO Traits

** TODO Methods and Other Members
