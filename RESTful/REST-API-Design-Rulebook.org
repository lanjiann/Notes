...
- [[2. Identifier Design with URIs - 11][2. Identifier Design with URIs - 11]]
  ...
  - [[URI Format - 11][URI Format - 11]]
    - [[Rule: Forward slash separator (/) must be used to indicate a hierarchical relationship - 12][Rule: Forward slash separator (/) must be used to indicate a hierarchical relationship - 12]]
    ...
    - [[Rule: Underscores (_) should not be used in URIs - 12][Rule: Underscores (_) should not be used in URIs - 12]]
    - [[Rule: Lowercase letters should be preferred in URI paths - 13][Rule: Lowercase letters should be preferred in URI paths - 13]]
    - [[Rule: File extensions should not be included in URIs - 13][Rule: File extensions should not be included in URIs - 13]]
  ...
  - [[URI Path Design - 16][URI Path Design - 16]]
    ...
    - [[Rule: Variable path segments may be substituted with identity-based values - 18 =RE-READ=][Rule: Variable path segments may be substituted with identity-based values - 18 =RE-READ=]]
  ...
  - [[Recap - 20 - =IMPORTANT=][Recap - 20 - =IMPORTANT=]]
