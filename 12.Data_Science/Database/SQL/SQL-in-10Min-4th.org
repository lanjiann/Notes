...
- [[Lesson 9. Summarizing Data][Lesson 9. Summarizing Data]]
  - [[9.1 Using Aggregate Functions][9.1 Using Aggregate Functions]]
    - [[9.1.1 The ~AVG()~ Function][9.1.1 The ~AVG()~ Function]]
    - [[9.1.2 The ~COUNT()~ Function][9.1.2 The ~COUNT()~ Function]]
    - [[9.1.3 The ~MAX()~ Function][9.1.3 The ~MAX()~ Function]]
    - [[9.1.4 The ~MIN()~ Function][9.1.4 The ~MIN()~ Function]]
    - [[9.1.5 The ~SUM()~ Function][9.1.5 The ~SUM()~ Function]]
...
- [[Lesson 10. Grouping Data - =TODO= =NOTE=][Lesson 10. Grouping Data - =TODO= =NOTE=]]
...
- [[Lesson 14. Combining Queries][Lesson 14. Combining Queries]]
  ...
  - [[14.2 Creating Combined Queries][14.2 Creating Combined Queries]]
    - [[14.2.1 Using ~UNION~][14.2.1 Using ~UNION~]]
    - [[14.2.2 ~UNION~ Rules][14.2.2 ~UNION~ Rules]]
    - [[14.2.3 Including or Eliminating Duplicate Rows][14.2.3 Including or Eliminating Duplicate Rows]]
    - [[14.2.4 Sorting Combined Query Results][14.2.4 Sorting Combined Query Results]]
