...
- [[Chapter 1  Facts, Rules, and Queries][Chapter 1  Facts, Rules, and Queries]]
  - [[1.1 Some Simple Examples][1.1 Some Simple Examples]]
    - [[Knowledge Base 1][Knowledge Base 1]]
    - [[Knowledge Base 2][Knowledge Base 2]]
    - [[Knowledge Base 3][Knowledge Base 3]]
    - [[Knowledge Base 4][Knowledge Base 4]]
    - [[Knowledge Base 5][Knowledge Base 5]]
  - [[1.2 Prolog Syntax][1.2 Prolog Syntax]]
    - [[Atoms][Atoms]]
    - [[Numbers][Numbers]]
    - [[Variables][Variables]]
    - [[Complex terms][Complex terms]]
  - [[1.3 Exercises][1.3 Exercises]]
  - [[1.4 Practical Session][1.4 Practical Session]]
- [[Chapter 2  Unification and Proof Search][Chapter 2  Unification and Proof Search]]
  - [[2.1 Unification][2.1 Unification]]
    - [[Examples][Examples]]
    - [[The occurs check][The occurs check]]
    - [[Programming with unification][Programming with unification]]
  - [[2.2 Proof Search][2.2 Proof Search]]
  - [[2.3 Exercises][2.3 Exercises]]
  - [[2.4 Practical Session][2.4 Practical Session]]
- [[Chapter 3  Recursion][Chapter 3  Recursion]]
  - [[3.1 Recursive Definitions][3.1 Recursive Definitions]]
    - [[Example 1: Eating][Example 1: Eating]]
    - [[Example 2: Descendant][Example 2: Descendant]]
    - [[Example 3: Successor][Example 3: Successor]]
    - [[Example 4: Addition][Example 4: Addition]]
  - [[3.2 Rule Ordering, Goal Ordering, and Termination][3.2 Rule Ordering, Goal Ordering, and Termination]]
  - [[3.3 Exercises][3.3 Exercises]]
  - [[3.4 Practical Session][3.4 Practical Session]]
- [[Chapter 4  Lists][Chapter 4  Lists]]
  - [[4.1 Lists][4.1 Lists]]
  - [[4.2 Member][4.2 Member]]
  - [[4.3 Recursing down Lists][4.3 Recursing down Lists]]
  - [[4.4 Exercises][4.4 Exercises]]
  - [[4.5 Practical Session][4.5 Practical Session]]
- [[Chapter 5  Arithmetic][Chapter 5  Arithmetic]]
  - [[5.1 Arithmetic in Prolog][5.1 Arithmetic in Prolog]]
  - [[5.2 A Closer Look][5.2 A Closer Look]]
  - [[5.3 Arithmetic and Lists][5.3 Arithmetic and Lists]]
  - [[5.4 Comparing Integers][5.4 Comparing Integers]]
  - [[5.5 Exercises][5.5 Exercises]]
  - [[5.6 Practical Session][5.6 Practical Session]]
- [[Chapter 6  More Lists][Chapter 6  More Lists]]
  - [[6.1 Append][6.1 Append]]
    - [[Defining ~append~][Defining ~append~]]
    - [[Using ~append~][Using ~append~]]
  - [[6.2 Reversing a List][6.2 Reversing a List]]
    - [[Naive ~reverse~ using ~append~][Naive ~reverse~ using ~append~]]
    - [[Reverse using an accumulator][Reverse using an accumulator]]
  - [[6.3 Exercises][6.3 Exercises]]
  - [[6.4 Practical Session][6.4 Practical Session]]
- [[Chapter 7  Definite Clause Grammars][Chapter 7  Definite Clause Grammars]]
  - [[7.1 Context Free Grammars][7.1 Context Free Grammars]]
    - [[CFG recognition using append][CFG recognition using append]]
    - [[CFG recognition using difference lists][CFG recognition using difference lists]]
  - [[7.2 Definite Clause Grammars][7.2 Definite Clause Grammars]]
    - [[A first example][A first example]]
    - [[Adding recursive rules][Adding recursive rules]]
    - [[A DCG for a simple formal language][A DCG for a simple formal language]]
  - [[7.3 Exercises][7.3 Exercises]]
  - [[7.4 Practical Session][7.4 Practical Session]]
- [[Chapter 8  More Definite Clause Grammars][Chapter 8  More Definite Clause Grammars]]
  - [[8.1 Extra Arguments][8.1 Extra Arguments]]
    - [[Context free grammars with features][Context free grammars with features]]
    - [[Building parse trees][Building parse trees]]
    - [[Beyond context free languages][Beyond context free languages]]
  - [[8.2 Extra Goals][8.2 Extra Goals]]
    - [[Separating rules and lexicon][Separating rules and lexicon]]
  - [[8.3 Concluding Remarks][8.3 Concluding Remarks]]
  - [[8.4 Exercises][8.4 Exercises]]
  - [[8.5 Practical Session][8.5 Practical Session]]
- [[Chapter 9  A Closer Look at Terms][Chapter 9  A Closer Look at Terms]]
  - [[9.1 Comparing Terms][9.1 Comparing Terms]]
  - [[9.2 Terms with a Special Notation][9.2 Terms with a Special Notation]]
    - [[Arithmetic terms][Arithmetic terms]]
    - [[Lists as terms][Lists as terms]]
  - [[9.3 Examining Terms][9.3 Examining Terms]]
    - [[Types of Terms][Types of Terms]]
    - [[The Structure of Terms][The Structure of Terms]]
    - [[Strings][Strings]]
  - [[9.4 Operators][9.4 Operators]]
    - [[Properties of operators][Properties of operators]]
    - [[Defining operators][Defining operators]]
  - [[9.5 Exercises][9.5 Exercises]]
  - [[9.6 Practical Session][9.6 Practical Session]]
- [[Chapter 10 Cuts and Negation][Chapter 10 Cuts and Negation]]
  - [[10.1 The Cut][10.1 The Cut]]
  - [[10.2 Using Cut][10.2 Using Cut]]
  - [[10.3 Negation as Failure][10.3 Negation as Failure]]
  - [[10.4 Exercises][10.4 Exercises]]
  - [[10.5 Practical Session][10.5 Practical Session]]
- [[Chapter 11 Database Manipulation and Collecting Solutions][Chapter 11 Database Manipulation and Collecting Solutions]]
  - [[11.1 Database Manipulation][11.1 Database Manipulation]]
  - [[11.2 Collecting Solutions][11.2 Collecting Solutions]]
    - [[The findall/3 predicate][The findall/3 predicate]]
    - [[The bagof/3 predicate][The bagof/3 predicate]]
    - [[The setof/3 predicate][The setof/3 predicate]]
  - [[11.3 Exercises][11.3 Exercises]]
  - [[11.4 Practical Session][11.4 Practical Session]]
- [[Chapter 12 Working With Files][Chapter 12 Working With Files]]
  - [[12.1 Splitting Programs over Files][12.1 Splitting Programs over Files]]
    - [[Reading in programs][Reading in programs]]
    - [[Modules][Modules]]
    - [[Libraries][Libraries]]
  - [[12.2 Writing to Files][12.2 Writing to Files]]
  - [[12.3 Reading from Files][12.3 Reading from Files]]
  - [[12.4 Exercises][12.4 Exercises]]
  - [[12.5 Practical Session][12.5 Practical Session]]
    - [[Step 1][Step 1]]
    - [[Step 2][Step 2]]
    - [[Step 3][Step 3]]
    - [[Step 4][Step 4]]
