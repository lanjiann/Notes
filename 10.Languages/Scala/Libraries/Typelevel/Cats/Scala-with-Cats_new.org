...
#+Date: November 2019 -- KEEP UPDATING!!!
#+STARTUP: overview
...
*** DONE 4.5.2 Raising and Handling Errors - 96
...
*** TODO 4.5.4 Exercise: Abstracting - 98 - =OPEN ISSUE=
    No exercise here -- there is an open issue for this in github

** DONE 4.6 The ~Eval~ Monad - 98
...
*** DONE 4.6.1 Eager, Lazy, Memoized, Oh My! - 98
...
*** DONE 4.6.2 Eval's Models of Evaluation - 100
...
*** DONE 4.6.3 ~Eval~ as a ~Monad~ - 102
...
*** DONE 4.6.4 Trampolining and ~Eval.defer~ - 103
...
*** TODO 4.6.5 Exercise: Safer Folding using ~Eval~ - 105
    =from Jian= I made a mistake at my first try. Try to do it again later.

** DONE 4.7 The ~Writer~ Monad - 105
...
*** DONE 4.7.1 Creating and Unpacking Writers - 106
...
*** DONE 4.7.2 Composing and Transforming Writers - 108
...
*** DONE 4.7.3 Exercise: Show Your Working - 110
    CLOSED: [2019-04-14 Sun 02:04]
...
*** DONE 4.8.1 Creating and Unpacking Readers - 112
...
*** DONE 4.8.2 Composing Readers - 112
    CLOSED: [2019-04-16 Tue 17:12]
...
*** DONE 4.8.3 Exercise: Hacking on Readers - 113
...
*** DONE 4.8.4 When to Use Readers? - 115
...
*** DONE 4.9.1 Creating and Unpacking State - 116
...
*** DONE 4.9.2 Composing and Transforming State - 117
...
*** DONE 4.9.3 Exercise: Post-Order Calculator - 119 - =TODO= =RE-READ=
    CLOSED: [2020-02-20 Thu 14:20]

** TODO 4.10 Defining Custom Monads - 123
   - TODO

*** TODO 4.10.1 Exercise: Branching out Further with Monads - 124
    #+begin_src scala
      sealed trait Tree[+A]
...
** DONE 5.1 Exercise: Composing Monads - 128
...
** DONE 5.2 A Transformative Example - 129
...
** DONE 5.3 Monad Transformers in Cats - 130
...
*** DONE 5.3.1 The Monad Transformer Classes - 131
...
*** DONE 5.3.2 Building Monad Stacks - 131
...
*** DONE 5.3.3 Constructing and Unpacking Instances - 134
...
*** DONE 5.3.4 Default Instances - 135
...
** DONE 5.4 Exercise: Monads: Transform and Roll Out - 138
   CLOSED: [2020-02-16 Sun 01:55]
** DONE 5.5 Summary - 139
...
* DONE 6 ~Semigroupal~ and ~Applicative~ - 141
...
*** DONE 6.1.1 Joining Two Contexts - 143
...
*** DONE 6.1.2 Joining Three or More Contexts - 143
    CLOSED: [2020-02-20 Thu 14:42]
...
*** DONE 6.2.1 Fancy Functors and Apply Syntax - 146 - =TODO= =???=
...
** DONE 6.3 ~Semigroupal~ Applied to Different Types - 147
...
*** DONE 6.3.1 Semigroupal Applied to Monads - 149
...
** TODO 6.4 ~Validated~ - 150 - =TODO= =Exercise=
   It is *impossible* for us to design a /monadic data type/ that implements
   error (=from Jian= parallel) accumulating semantics without breaking the
   consistency of ~flatMap~, ~map~, and ~product~.
   - Cats provides a /data type/ called ~Validated~ that has an instance of
     ~Semigroupal~ but *NO* /instance/ of ~Monad~.
     _The implementation of ~product~ is therefore free to accumulate errors_:
     #+begin_src scala
       import cats.Semigroupal
   ...
   - ~Validated~ (accumulating) _complements_ ~Either~ (fail fast) nicely.

*** DONE 6.4.1 Creating Instances of Validated - 150
    CLOSED: [2020-02-20 Thu 15:58]
    ...
    - Construct ~Validated~ values
      + Use the ~apply~ methods of corresponding subtypes, which is
        ...
        #+end_src
        =from Jian=
        I don't prefer this way because of their return types are the subtypes, which
        is may lead to some issues.
          The /static methods/ below can return the ~Validated~ type, which is preferred!
...
*** DONE 6.4.2 Combining Instances of Validated - 152
    CLOSED: [2020-02-20 Thu 16:14]
    - We can _combine_ instances of ~Validated~ using any of the methods or syntax
    ...
    - ~Validated~ accumulates errors using a ~Semigroup~, so we need one of those
      in scope to summon the ~Semigroupal~. If no proper ~Semigroup~ instance in
      scope, we get an _ANNOYINGLY *unhelpful* compilation error_:
      #+begin_src scala
      ...
      #+begin_src scala
        ...
        Semigroupal[AllErrorsOr]
        // res13: cats.Semigroupal[AllErrorsOr] = cats.data.ValidatedInstances$$anon$1@533850f5
      #+end_src

    - We can also use ~NonEmptyList~ and ~NonEmptyVector~ types to prevent us
      failing without at least one error!!!
      =from Jian= This is important. Mostly, we don't want to fail without any log or hint.

*** DONE 6.4.3 Methods of Validated - 154 - =TODO= _more practice_
    CLOSED: [2020-02-20 Thu 16:20]
...
*** TODO 6.4.4 Exercise: Form Validation - 155

** DONE 6.5 ~Apply~ and ~Applicative~ - 157
...
*** DONE 6.5.1 The Hierarchy of Sequencing Type Classes - 158
    CLOSED: [2020-02-21 Fri 10:36]
...
** D.4 Safer Folding using Eval - 250
** D.5 Show Your Working - 251
** D.6 Hacking on Readers - 253
** D.7 Hacking on Readers Part 2 - 253
** D.8 Hacking on Readers Part 3 - 254
** D.9 Post-Order Calculator - 254
** D.10 Post-Order Calculator Part 2 - 255
** D.11 Post-Order Calculator Part 3 - 256
** D.12 Branching out Further with Monads - 256
...
** F.1 The Product of Monads - 265
** F.2 Form Validation - 266
** F.3 Form Validation Part 2 - 267
** F.4 Form Validation Part 3 - 268
** F.5 Form Validation Part 4 - 268
** F.6 Form Validation Part 5 - 269

* TODO Appendix G Solutions for: ~Foldable~ and ~Traverse~ - 271
** G.1 Reflecting on Folds - 271
** G.2 Scaf-fold-ing Other Methods - 272
** G.3 Traversing with Vectors - 273
** G.4 Traversing with Vectors Part 2 - 274
** G.5 Traversing with Options - 274
** G.6 Traversing with Validated 275

* TODO Appendix H. Solutions for: Case Study: Testing Asynchronous Code - 277
** H.1 Abstracting over Type Constructors - 277
** H.2 Abstracting over Type Constructors Part 2 - 278
** H.3 Abstracting over Monads - 278
** H.4 Abstracting over Monads Part 2 - 279

* TODO Appendix I. Solutions for: Case Study: Map-Reduce - 281
** I.1 Implementing ~foldMap~ - 281
** I.2 Implementing ~foldMap~ Part 2 - 281
** I.3 Implementing ~parallelFoldMap~ - 282
** I.4 ~parallelFoldMap~ with more Cats - 284

* TODO Appendix J. Solutions for: Case Study: Data Validation - 287
** J.1 Basic Combinators - 287
** J.2 Basic Combinators Part 2 - 288
** J.3 Basic Combinators Part 3 - 288
** J.4 Basic Combinators Part 4 - 292
** J.5 Basic Combinators Part 5 - 293
** J.6 Checks - 294
** J.7 Checks Part 2 - 295
** J.8 Checks Part 3 - 296
** J.9 Recap - 296
** J.10 Recap Part 2 - 300
** J.11 Kleislis - 302
** J.12 Kleislis Part 2 - 302
