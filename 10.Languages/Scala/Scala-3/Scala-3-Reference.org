...
#+VERSION: 3.0.0-RC2-bin-20210226-63a467b-NIGHTLY
...
**** DONE Generic Extensions
     ...
     - /Type parameters on extensions/ can also be _combined with_ /type parameters
       ...
       * By contrast,
         /type arguments/ matching /type parameters following extension/ can be
         passed *only if the /method/ is referenced as a _non-extension method_:*
         #+begin_src scala
         ...
         + =FIXME=
           The *only if* looks wrong. Both of the 4 forms work:
           #+begin_src scala
             // Non-extension method calls
             sumBy[String](List("a", "bb", "ccc"))(_.length)
             sumBy[String](List("a", "bb", "ccc"))[Int](_.length)
           ...
           #+end_src
           * Personally,
             I think the /type arguments/ usage in the _non-extension method calls_ looks weird.
