...
#+VERSION: 3.0.0-M3-bin-20201208-f334e3f-NIGHTLY
...
*** DONE Restrictions
    ...
    - These constructs are restricted to make the language safer.
      ...
      * _Multiversal Equality_ implements an "opt-in" scheme to rule out
        nonsensical comparisons with ~==~ and ~!=~.
...
**** DONE Negated Givens
     ...
     ~Q1~ succeeds if ~Q2~ fails._
       ...
       BUT there is now a new special type ~scala.util.NotGiven~ which implements
     negation directly.
