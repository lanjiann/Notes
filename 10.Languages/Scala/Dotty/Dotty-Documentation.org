...
#+VERSION: 3.0.0-RC1-bin-20201228-029ae77-NIGHTLY --> 3.0.0-RC1-bin-20210101-141bf9e-NIGHTLY
...
*** DONE Optional Braces - =TODO= =READ "Settings and Rewrites"=
     ...
     - An extension method ~.nn~ to "cast away" nullability
       #+begin_src scala
         def[T] (x: T | Null) nn: x.type & T =
           if x == null
           then new NullPointerException("tried to cast away nullability, but value is null")
