...
* TODO 7. Managing Growing Projects with Packages, Crates, and Modules - 111 - =START=
...
** TODO Bringing Paths into Scope with the ~use~ Keyword - 121
...
** TODO Separating Modules into Different Files - 127
** Summary - 128

* DONE 8. Common Collections - 131
  CLOSED: [2021-01-07 Thu 01:05]
...
** TODO Recoverable Errors with ~Result~ - 155
   - Definition
     #+BEGIN_SRC rust
       enum Result<T, E> {
           Ok(T),
...
**** DONE A Shortcut for Propagating Errors: the ~?~ Operator - 162
     ...
     - /error values/ that have the ~?~ operator called on them go through the
       ...
       * This is useful when a /function/ returns *one* /error type/ to represent
         ...
         how to convert itself to the returned /error type/, the ~?~ operator
...
**** The ~?~ Operator Can Be Used in Functions That Return ~Result~ - 163 - =START=
