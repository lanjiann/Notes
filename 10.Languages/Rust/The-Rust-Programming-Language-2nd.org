...
** DONE Command Line Notation - 2
   CLOSED: [2019-09-26 Thu 02:37]
*** DONE Installing rustup on Linux or Mac - 2
    CLOSED: [2017-08-16 Wed 00:35]
    ~$ curl https://sh.rustup.rs -sSf | sh~

*** TODO Installing rustup on Windows - 3
*** DONE Updating and Uninstalling - 3
    CLOSED: [2017-08-16 Wed 00:37]
    - ~$ rustup update~
    - ~$ rustup self uninstall~

*** DONE Troubleshooting - 3
    - Rust version info:
      ~$ rustc --version~
      The output is like:
