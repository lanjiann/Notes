...
* TODO 3. Basic types - 43
  ...
  - Here's a summary of the sorts of /types/ you'll see in Rust.
    ...
    TODO TODO TODO TODO TODO TODO =Re-READ= TODO TODO TODO TODO TODO TODO TODO TODO
    ...
    + Signed and unsigned integers, the same size as an address on the machine
      (32 or 64 bits)
      * Types: ~isize~, ~usize~
...
** DONE Why Rust Has ~loop~ - 133 =Re-Read=
   ...
   for some reason (mentioned in the book) TODO, and the designer create ~loop~.

   =From Jian=
   This is a plausible reason.
   It is a non-fundamental solution, and a patchy solution!!!
   The ~while true~ issue should be resolved!!! WHY NOT?!?!?!
