...
** DONE 9. Style - 95
  ...
  - Rule 2.9.0.1 :: All C code must be readable.
  - Rule 2.9.0.2 :: Short term memory and the field of vision are small.
  - Rule 2.9.0.3 :: Coding style is not a question of taste but of culture.
  - Rule 2.9.0.4 :: When you enter an established project you enter a new cultural space.
...
*** 11.1. Address-of and object-of operators - 108
    - Rule 2.11.1.1 :: Using ~*~ with an indeterminate or null pointer has un-
                       defined behavior.

*** 11.2. Pointer arithmetic - 109
    - Rule 2.11.2.1 :: A valid pointer addresses the first element of an array of
                       the base type.
    ...
    - Rule 2.11.2.6 :: A pointer must point to a valid object, one position
                       beyond a valid object or be null.
