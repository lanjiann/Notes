...
- [[1. Introduction to High Performance Spark - 1][1. Introduction to High Performance Spark - 1]]
  ...
  - [[What You Can Expect to Get from This Book - 2 - =Re-READ=][What You Can Expect to Get from This Book - 2 - =Re-READ=]]
...
- [[3. DataFrames, Datasets, and Spark SQL - 27][3. DataFrames, Datasets, and Spark SQL - 27]]
  ...
  - [[~DataFrame~ API - 36][~DataFrame~ API - 36]]
    - [[Transformations - 36][Transformations - 36]]
      - [[Simple ~DataFrame~ transformations and SQL expressions - 37][Simple ~DataFrame~ transformations and SQL expressions - 37]]
      - [[Specialized ~DataFrame~ transformations for missing and noisy data - 42][Specialized ~DataFrame~ transformations for missing and noisy data - 42]]
      - [[Beyond row-by-row transformations - 42][Beyond row-by-row transformations - 42]]
      - [[Aggregates and groupBy - 43][Aggregates and groupBy - 43]]
      - [[Windowning - 46][Windowning - 46]]
      - [[Sorting - 48][Sorting - 48]]
    - [[Multi-DataFrame Transformations - 48][Multi-DataFrame Transformations - 48]]
      - [[Set-like operations - 48][Set-like operations - 48]]
    - [[Plain Old SQL Queries and Interacting with Hive Data - 49][Plain Old SQL Queries and Interacting with Hive Data - 49]]
  - [[Data Representation in ~DataFrame~'s and ~Dataset~'s - 49][Data Representation in ~DataFrame~'s and ~Dataset~'s - 49]]
