...
- [[Preface - xi][Preface - xi]]
  - [[The Origins of Go - xii =IMPORTANT= =INTERESTING= =RE-READ=][The Origins of Go - xii =IMPORTANT= =INTERESTING= =RE-READ=]]
...
- [[1. Tutorial - 1][1. Tutorial - 1]]
  ...
  - [[1.6. Fetching URLs Concurrently - 17][1.6. Fetching URLs Concurrently - 17]]
...
- [[2. Program Structure - 27][2. Program Structure - 27]]
  ...
  - [[2.3. Variables - 30][2.3. Variables - 30]]
    - [[2.3.1. Short Variable Declarations - 30][2.3.1. Short Variable Declarations - 30]]
    - [[2.3.2. Pointers - 32][2.3.2. Pointers - 32]]
    - [[2.3.3. The ~new~ Function - 34][2.3.3. The ~new~ Function - 34]]
    - [[2.3.4. Lifetime of Variables - 35][2.3.4. Lifetime of Variables - 35]]
  - [[2.4. Assignments - 36][2.4. Assignments - 36]]
    - [[2.4.1. Tuple Assignment - 37][2.4.1. Tuple Assignment - 37]]
    - [[2.4.2. Assignability - 38][2.4.2. Assignability - 38]]
  - [[2.5. Type Declarations - 39][2.5. Type Declarations - 39]]
  - [[2.6. Packages and Files - 41][2.6. Packages and Files - 41]]
    - [[2.6.1. Imports - 43][2.6.1. Imports - 43]]
    - [[2.6.2. Package Initialization - 44 =RE-READ=][2.6.2. Package Initialization - 44 =RE-READ=]]
...
- [[3. Basic Data Types - 51][3. Basic Data Types - 51]]
  ...
  - [[3.5. Strings - 64][3.5. Strings - 64]]
    - [[3.5.1. String Literals][3.5.1. String Literals]]
    - [[3.5.2. String Literals][3.5.2. String Literals]]
    - [[3.5.3. UTF-8][3.5.3. UTF-8]]
    - [[3.5.4. Strings and Byte Slices][3.5.4. Strings and Byte Slices]]
    - [[3.5.5. Conversions between Strings and Numbers][3.5.5. Conversions between Strings and Numbers]]
  - [[3.6. Constants - 75][3.6. Constants - 75]]
    - [[3.6.1. The Constant Generator iota][3.6.1. The Constant Generator iota]]
    - [[3.6.2. Untyped Constants][3.6.2. Untyped Constants]]
- [[4. Composite Types - 81][4. Composite Types - 81]]
  - [[4.1. Arrays - 81][4.1. Arrays - 81]]
  - [[4.2. Slices - 84][4.2. Slices - 84]]
    - [[4.2.1. The append Function - 88][4.2.1. The append Function - 88]]
    - [[4.2.2. In-Place Slice Techniques - 91][4.2.2. In-Place Slice Techniques - 91]]
  - [[4.3. Maps - 93][4.3. Maps - 93]]
  - [[4.4. Structs - 99][4.4. Structs - 99]]
    - [[4.4.1. Struct Literals - 102][4.4.1. Struct Literals - 102]]
    - [[4.4.2. Comparing Structs - 104][4.4.2. Comparing Structs - 104]]
    - [[4.4.3. Struct Embedding and Anonymous Fields - 104][4.4.3. Struct Embedding and Anonymous Fields - 104]]
...
- [[5. Functions - 119][5. Functions - 119]]
  ...
  - [[5.4. Errors - 127][5.4. Errors - 127]]
    - [[5.4.1. Error-Handling Strategies - 129 =TODO: RE-WRITE NOTES=][5.4.1. Error-Handling Strategies - 129 =TODO: RE-WRITE NOTES=]]
    - [[5.4.2. End of File (EOF) - 131][5.4.2. End of File (EOF) - 131]]
  - [[5.5. Function Values - 132][5.5. Function Values - 132]]
  - [[5.6. Anonymous Functions - 135][5.6. Anonymous Functions - 135]]
    - [[5.6.1. Caveat: Capturing Iteration Variables - 140][5.6.1. Caveat: Capturing Iteration Variables - 140]]
...
- [[6. Methods - 155][6. Methods - 155]]
  ...
  - [[6.2. Methods with a Pointer Receiver - 158][6.2. Methods with a Pointer Receiver - 158]]
    - [[6.2.1. Nil Is a Valid Receiver Value - 160][6.2.1. Nil Is a Valid Receiver Value - 160]]
...
- [[7. Interfaces - 171][7. Interfaces - 171]]
  ...
  - [[7.5. Interface Values - 181][7.5. Interface Values - 181]]
    - [[7.5.1. Caveat: An Int erface Containing a Nil Pointer Is NonNil - 185][7.5.1. Caveat: An Int erface Containing a Nil Pointer Is NonNil - 185]]
...
- [[8. Goroutines and Channels - 217][8. Goroutines and Channels - 217]]
  ...
  - [[8.4. Channels - 225][8.4. Channels - 225]]
    - [[8.4.1. Unbuffered Channels - 226][8.4.1. Unbuffered Channels - 226]]
    - [[8.4.2. Pipelines - 228][8.4.2. Pipelines - 228]]
    - [[8.4.3. Unidirectional Channel Types - 230][8.4.3. Unidirectional Channel Types - 230]]
    - [[8.4.4. Buffered Channels - 231][8.4.4. Buffered Channels - 231]]
...
- [[9. Concurrency with Shared Variables - 257][9. Concurrency with Shared Variables - 257]]
  ...
  - [[9.8. Goroutines and Threads - 280][9.8. Goroutines and Threads - 280]]
    - [[9.8.1. Gro wable Stacks - 280][9.8.1. Gro wable Stacks - 280]]
    - [[9.8.2. Goroutine Scheduling - 280][9.8.2. Goroutine Scheduling - 280]]
    - [[9.8.3. GOMAXPROCS - 281][9.8.3. GOMAXPROCS - 281]]
    - [[9.8.4. Goroutines Have No Identity - 282][9.8.4. Goroutines Have No Identity - 282]]
- [[10. Packages and the Go Tool - 283][10. Packages and the Go Tool - 283]]
  ...
  - [[10.7. The Go Tool - 290][10.7. The Go Tool - 290]]
    - [[10.7.1. Workspace Organization - 291][10.7.1. Workspace Organization - 291]]
    - [[10.7.2. Downloading Packages - 292][10.7.2. Downloading Packages - 292]]
    - [[10.7.3. Building Packages - 293][10.7.3. Building Packages - 293]]
    - [[10.7.4. Documenting Packages - 296][10.7.4. Documenting Packages - 296]]
    - [[10.7.5. Int ernal Packages - 298][10.7.5. Int ernal Packages - 298]]
    - [[10.7.6. Querying Packages - 299][10.7.6. Querying Packages - 299]]
- [[11. Testing - 301][11. Testing - 301]]
  ...
  - [[11.2. Test Functions - 302][11.2. Test Functions - 302]]
    - [[11.2.1. Randomized Testing - 397][11.2.1. Randomized Testing - 397]]
    - [[11.2.2. Testing a Command - 308][11.2.2. Testing a Command - 308]]
    - [[11.2.3. White-Box Testing - 310][11.2.3. White-Box Testing - 310]]
    - [[11.2.4. External Test Packages - 314][11.2.4. External Test Packages - 314]]
    - [[11.2.5. Write Effective Tests - 316][11.2.5. Write Effective Tests - 316]]
    - [[11.2.6. Avoiding Brittle Tests - 317][11.2.6. Avoiding Brittle Tests - 317]]
...
** TODO 3.6. Constants - 75
   - Constants :: expressions whose value is known to the compiler and whose
                  evaluation is guaranteed to occur at /compile time/, *NOT* at
                  /run time/.
